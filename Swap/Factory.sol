...
contract PancakePair is IPancakePair, PancakeERC20 {
    ...
    // if fee is on, mint liquidity equivalent to 15/30 of the growth in sqrt(k)
        ...
        if (feeOn) {
            if (_kLast != 0) {
                ...
                if (rootK > rootKLast) {
                    ...
                    uint denominator = rootK.mul(15).add(rootKLast.mul(15));
...
contract AmpleFactory is IPancakeFactory {
